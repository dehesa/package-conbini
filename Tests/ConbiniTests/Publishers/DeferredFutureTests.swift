...
final class DeferredFutureTests: XCTestCase {
    ...
    static var allTests = [
        ("testSuccessfulSyncCompletion", testSuccessfulSyncCompletion),
        ("testSuccessfulAsyncCompletion", testSuccessfulAsyncCompletion),
        ("testSuccessfulSyncFailure", testSuccessfulSyncFailure),
        ("testSuccessfulAsyncFailure", testSuccessfulAsyncFailure)
    ]
