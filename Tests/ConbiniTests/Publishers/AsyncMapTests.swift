...
final class AsyncMapTests: XCTestCase {
    ...
    static var allTests = [
        ("testAsyncMapUnlimitedSingleValue", testAsyncMapUnlimitedSingleValue),
        ("testAsyncMapUnlimitedArray", testAsyncMapUnlimitedArray),
        ("testAsyncMapUnlimitedMulti", testAsyncMapUnlimitedMulti),
        ("testAsyncMapRestrictedArrayOne", testAsyncMapRestrictedArrayOne),
        ("testAsyncMapRestrictedArrayTwo", testAsyncMapRestrictedArrayTwo),
        ("testAsyncMapRestrictedMulti", testAsyncMapRestrictedMulti),
        ("testAsyncTryMapUnlimitedSingleValue", testAsyncTryMapUnlimitedSingleValue),
        ("testAsyncTryMapUnlimitedArray", testAsyncTryMapUnlimitedArray),
        ("testAsyncTryMapUnlimitedMulti", testAsyncTryMapUnlimitedMulti),
        ("testAsyncTryMapUnlimitedError", testAsyncTryMapUnlimitedError),
        ("testAsyncTryMapRestrictedArrayOne", testAsyncTryMapRestrictedArrayOne),
        ("testAsyncTryMapRestrictedArrayTwo", testAsyncTryMapRestrictedArrayTwo),
        ("testAsyncTryMapRestrictedMulti", testAsyncTryMapRestrictedMulti)
    ]
}
