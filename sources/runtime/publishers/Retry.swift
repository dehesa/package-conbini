...
extension Publishers {
  ...
  public struct DelayedRetry<Upstream,S>: Publisher where Upstream:Publisher, S:Scheduler {
    ...
    public func receive<S>(subscriber: S) where S:Subscriber, S.Input==Output, S.Failure==Failure {
      let conduit = DelayedRetry._Conduit(upstream: self.upstream, downstream: subscriber,
...
private extension Publishers.DelayedRetry {
...
private extension Publishers.DelayedRetry._Conduit {
